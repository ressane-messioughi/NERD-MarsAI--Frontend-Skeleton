...
export function LandingPageNavbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-[60px] bg-card/95 backdrop-blur-md border-b border-border/50" role="navigation" aria-label="Navigation principale">
      <div className="container mx-auto px-4 md:px-6 h-full flex items-center justify-between gap-4">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link to="/jury">
            <Button 
              ...
              aria-current={isActive('/jury') ? 'page' : undefined}
            >
              {t('nav.jury')}
            </Button>
          </Link>
        ...
        {/* Desktop Right Section - Language */}
        <div className="hidden md:flex items-center gap-3">
